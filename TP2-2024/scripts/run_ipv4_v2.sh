...
osascript -e 'tell application "Terminal" to do script "cd '$(pwd)'/../cod; ./server v4 12345; exec zsh"' &
osascript -e 'tell application "Terminal" to do script "cd '$(pwd)'/../cod; ./server v4 54321; exec zsh"' &
...
osascript -e 'tell application "Terminal" to do script "cd '$(pwd)'; ./../cod/client 127.0.0.1 12345 54321; exec zsh"' &
osascript -e 'tell application "Terminal" to do script "cd '$(pwd)'; ./../cod/client 127.0.0.1 12345 54321; exec zsh"' &
